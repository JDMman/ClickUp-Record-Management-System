...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <h4><p><i>Select the type of Appointment you desired to create a schedule request.</i></p></h4>
        <h5><p><i>List of Requirements. </h5></i></p>
        <h6><p><i>For Wedding: </h6>Birth certificate
<br>Baptismal certificate<br>
Confirmation certificate<br>
Marriage licensed<br>
Cenomar</br>

<p><i><h6>For Mass of Death:</h6>Death certificate</i></br></P>


<br><h6>For Baptism:</h6>

Birth certificate</i></p>
        <hr>
        <div class="col-12">
            <div class="row">
